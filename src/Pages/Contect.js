...
const Contect = () => {
  ...
  return (
    <div className='w-[50%] bg-slate-500 m-auto block mt-8 p-4 rounded-md'>
      ...
      <input className='w-[100%] mb-4 h-[40px] border border-inherit outline-none rounded-md pl-2' type="text" name="user_name" />
      <label className='font-semibold text-[16px]'>Email</label>
      <input className='w-[100%] mb-4 h-[40px] border border-inherit outline-none rounded-md pl-2' type="email" name="user_email" />
      <label className='font-semibold text-[16px]'>Message</label>
      <textarea name="message" className='w-[100%] h-[100px] outline-none rounded-sm pl-2' />
