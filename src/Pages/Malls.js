  ...
  return (
    ...
    {malls.map(res => (
        <div className='m-auto w-[80%]  p-2 rounded-md bg-white mb-4' key={res.id}>
         ...
         <img src={res.image[0]} alt='' className='w-[470px] xls:w-[760px] h-[160px] xls:h-[500px] md:h-[400px] rounded-md m-auto mb-4' />
         <img src={res.image[1]} alt='' className='w-[470px] xls:w-[760px] h-[160px] xls:h-[500px] md:h-[400px] rounded-md m-auto mb-4' />
         <img src={res.image[2]} alt='' className='w-[470px] xls:w-[760px] h-[160px] xls:h-[500px] md:h-[400px] rounded-md m-auto mb-4' />
         ...
         <i className="fa-sharp xls:text-[30px] fa-solid fa-location-dot mr-2"></i>
         kenya nairobi.....
         </p>
